...
public class ScrollableGestureDetector extends InputAdapter {
	...
	public ScrollableGestureDetector (float halfTapSquareSize, float tapCountInterval, float longPressDuration, float maxFlingDelay,
	 ...
	 *           {@link GestureDetector.GestureListener#fling(float, float, int)}
	 * @param listener May be null if the listener will be set later. */
	public ScrollableGestureDetector (float halfTapRectangleWidth, float halfTapRectangleHeight, float tapCountInterval, float longPressDuration, float maxFlingDelay,
	                        GestureListener listener) {
